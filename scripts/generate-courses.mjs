...
import { writeAgentKnowledgePage } from './write-agent-knowledge-page.mjs';
...
const agentPage = writeAgentKnowledgePage(output);
console.log(`Generated ${output.length} courses`);
console.log(`Agent knowledge page: ${agentPage}`);
